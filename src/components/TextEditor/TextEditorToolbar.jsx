...
const TextEditorToolbar = ({ onFormat }) => {
  return (
    <ToolbarContainer>
      <ButtonGroup>
        <ToolbarButton title="加粗" onClick={() => onFormat('bold')}>
        ...
        <ToolbarButton title="斜体" onClick={() => onFormat('italic')}>
          <svg viewBox="0 0 24 24">
            <path fill="currentColor" d="M10,4V7H12.21L8.79,15H6V18H14V15H11.79L15.21,7H18V4H10Z"/>
          </svg>
        </ToolbarButton>
        <ToolbarButton title="下划线" onClick={() => onFormat('underline')}>
          <svg viewBox="0 0 24 24">
      ...
      <ButtonGroup>
        ...
        <ToolbarButton title="居中对齐" onClick={() => onFormat('alignCenter')}>
          <svg viewBox="0 0 24 24">
      ...
      {/* 暂时注释掉其他未实现的功能按钮 */}
      {/*<ButtonGroup>
        <ToolbarButton title="字号">字号</ToolbarButton>
        <ToolbarButton title="字体">字体</ToolbarButton>
        <ToolbarButton title="字体颜色">字体颜色</ToolbarButton>
        <ToolbarButton title="行距">行距</ToolbarButton>
      </ButtonGroup>*/}
    </ToolbarContainer>
  );
};
